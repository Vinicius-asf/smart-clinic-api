module.exports = app => {
    ...
    const getClinicInformation = async (clinic_id) => {
        try {
            const clinic_professionals_list = await app.db('clinics_healthcare_professional')
            ...
            .andWhere('clinics_healthcare_professional.deleted_at',null)
            .andWhere('healthcare_professional.deleted_at',null)
            .andWhere('professional_speciality.deleted_at',null)
